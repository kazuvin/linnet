...
export default function Home() {
  return (
    <main className="container mx-auto grid gap-[var(--grid-gap)] px-4 pt-20 pb-12 max-lg:gap-[var(--grid-gap-sm)] lg:pt-24">
      <KeySelector />
      <div className="grid grid-cols-1 gap-[var(--grid-gap)] max-lg:gap-[var(--grid-gap-sm)] lg:grid-cols-[2fr_3fr]">
